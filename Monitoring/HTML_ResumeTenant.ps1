...
$RightLogo = "img/logo1.jpg"

#Location the report will be saved to
$ReportSavePath = "C:\inetpub\wwwroot"
...
If ($2FA -eq $False)
{
	$AdminName = adminuser@company.com
	$Pass = P@$$W0rd
...
#header
$rpt += get-htmlopenpage -TitleText '' -LeftLogoString $CompanyName
