# Script:   Excel_ResumeTenant
# Purpose:  This script get details about the 365 Tenant and export to Excel file
...
$Sheet_LicensedMailboxes.Cells.Item($row, $column).Font.ColorIndex = 2
$Sheet_LicensedMailboxes.Cells.Item($row, $column).Font.ThemeFont = 1
$Users = Get-Msoluser -EnabledFilter EnabledOnly -MaxResults 777777 | Where-Object { $_.IsLicensed -eq $True } | Sort-Object DisplayName
